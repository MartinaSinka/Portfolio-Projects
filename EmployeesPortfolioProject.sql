...
SELECT 
    ...
    COUNT(e.emp_no) AS 'Total_Number_Of_Employees'
FROM
    t_employees e
...
---------------------------------------------------------------------------------------
#Comparing the average salary of female versus male employees in the entire company
#until year 2002.
SELECT 
    e.gender,
    d.dept_name,
...
ORDER BY d.dept_no;
---------------------------------------------------------------------------------------------
#Creating a stored procedure that will allow us to obtain the average male and female salary 
#per department within a certain salary range. This range will be defined by two values
